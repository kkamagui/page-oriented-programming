...
#define SHADOWBOX_USE_HW_BREAKPOINT		0
//#define SHADOWBOX_USE_DESC_TABLE		1
#define SHADOWBOX_USE_DESC_TABLE		0
//#define SHADOWBOX_USE_PRE_TIMER			1
#define SHADOWBOX_USE_PRE_TIMER			0
#define SHADOWBOX_USE_I915_WORKAROUND	0
#define SHADOWBOX_USE_SLEEP				0
#define SHADOWBOX_USE_USER_WAITPKG		1
#define SHADOWBOX_USE_MBEC				1
...
#define SHADOWBOX_USE_TERMINATE_MALICIOUS_PROCESS	0
//#define SHADOWBOX_USE_TERMINATE_MALICIOUS_MODULE	1
#define SHADOWBOX_USE_TERMINATE_MALICIOUS_MODULE	0

#define SHADOWBOX_USE_CFI							1
...
/* Shadow-box helper module name. */
#define HELPER_MODULE_NAME				"shadow_box_helper"
...
#define VM_BIT_VM_SEC_PROC_CTRL_ENABLE_MBEC  	(0x01 << 22)
#define VM_BIT_VM_SEC_PROC_CTRL_ENABLE_USER_WAIT 	(0x01 << 26)
...
#define CR4_BIT_CET								((u64)0x01 << 23)
...
extern struct mutex* g_module_mutex;
